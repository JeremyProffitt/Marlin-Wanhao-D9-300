...
#define		MACRO_var_V08D					0x002A	
#define		MACRO_var_V08E					0x002B	
...
#define		VARVAL_TOOL_HOT_HOTEND					0x0037	
#define		VARVAL_TOOL_HOT_BED						0x0038	
#if MACRO_var_V011==MACRO_var_V003
...
#define		DWINPAGE_EXIST(x)	(defined(PAGENUM_##x)&&PAGENUM_##x>0)
#define		DWINPAGE(x)	PAGENUM_##x
